...
#define LOADER_END              0x04BFF        // Defined by size of the bootloader code and/or protection fuses 
#define LOADER_RESET            RESET_VECTOR 
#define LOADER_HIGH_INT         LOADER_START 
#define LOADER_NORMAL_INT       LOADER_HIGH_INT + 0x10 

#define APPLICATION_SETTINGS	LOADER_END + 2;
#define APPLICATION_SETTING_SIZE	1024
#define APPLICATION_SETTINGS_END 0x4FFF

#define APPLICATION_START       0x5000	//APPLICATION_SETTINGS_END + 2 
...
#define APPLICATION_NORMAL_INT  APPLICATION_START + NORMAL_INT_VECTOR 
  ...
  #org 0, APPLICATION_SETTINGS_END {}   // Reserve the bootloader memory area 
#endif 
